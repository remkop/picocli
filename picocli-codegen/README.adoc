...
dependencies {
    ...
    annotationProcessor 'info.picocli:picocli-codegen:4.0.0-beta-2'
}
```
...
dependencies {
    compile 'info.picocli:picocli:4.0.0-beta-2'
    compileOnly 'info.picocli:picocli-codegen:4.0.0-beta-2'
}
```
...
dependencies {
    compile 'info.picocli:picocli:4.0.0-beta-2'
    generateConfig 'info.picocli:picocli-codegen:4.0.0-beta-2'
}
```
