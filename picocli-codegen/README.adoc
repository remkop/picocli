...
The annotation processor generates and updates https://github.com/oracle/graal/blob/master/substratevm/BuildConfiguration.md[GraalVM configuration]
...
dependencies {
    implementation 'info.picocli:picocli:4.6.0'
    compileOnly 'info.picocli:picocli-codegen:4.6.0'
}
```
...
See also the SubstrateVM https://github.com/oracle/graal/blob/master/substratevm/BuildConfiguration.md[configuration documentation].
...
dependencies {
    implementation 'info.picocli:picocli:4.6.0'
    generateConfig 'info.picocli:picocli-codegen:4.6.0'
}
----
...
https://github.com/oracle/graal/blob/master/substratevm/DynamicProxy.md[need to be generated] at native image build time.
