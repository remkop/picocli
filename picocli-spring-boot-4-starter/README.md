...
# Picocli Spring Boot 4 Starter - Enables Spring Dependency Injection in Picocli Commands
...
Picocli 4.7.8-SNAPSHOT has been tested with Spring Boot 4.0.3.
...
<dependency>
  ...
  <artifactId>picocli-spring-boot-4-starter</artifactId>
...
```
dependencies {
    implementation "info.picocli:picocli-spring-boot-4-starter:4.7.8-SNAPSHOT"
}
```

This will bring in the `info.picocli:picocli` and `org.springframework.boot:spring-boot-4-starter` dependencies.
