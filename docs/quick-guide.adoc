...
class GitCommit { ... }
----
The usage help message generated from this class is shown below in https://picocli.info/#_expanded_example[Expanded Example].
...
----
This command has the following usage help message:
----
...
[source,java]
----
enum Lang { java, groovy, kotlin, scala, javascript, frege, clojure }
...
Usage: <main class> -l=<lang> -o=<option>
  -l=<lang>     Enum values: java, groovy, kotlin, scala, javascript, frege, clojure
...
class Example {
    @Option(names = {"-a", "--alpha"}, description = "optional") String alpha;
    @Option(names = {"-b", "--beta"}, required = true, description = "mandatory") String beta;
}
----
Produces the following usage help message:
----
Usage: <main class> [OPTIONS]
  -a, --alpha=<alpha>   optional
* -b, --beta=<beta>     mandatory
----
