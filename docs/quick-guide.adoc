...
----
$ java -cp "myapp.jar;picocli-4.7.7.jar" ASCIIArt --font-size=9 Hello picocli
       #   #       #  #                 #                  #  #
       #   #       #  #                                    #
       #   #  ***  #  #  ****     #***  #  **#  ****  **#  #  #
       #####  ***  #  #  ****     #***  #  **   ****  **   #  #
...
----
$ java -cp "myapp.jar;picocli-4.7.7.jar" ISOCodeResolver language de cs en sd se
de: German
cs: Czech
en: English
sd: Sindhi
...
----
$ java -cp "myapp.jar;picocli-4.7.7.jar" ISOCodeResolver country cn fr th ro no
CN: China
FR: France
TH: Thailand
RO: Romania
