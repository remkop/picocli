...
----
$ java -cp "myapp.jar;picocli-4.5.2-SNAPSHOT.jar" ASCIIArt --font-size=9 Hello picocli
       #   #       #  #                 #                  #  #                                                                                 
       #   #       #  #                                    #                                                                                    
       #   #  ***  #  #  ****     #***  #  **#  ****  **#  #  #                                                                                 
       #####  ***  #  #  ****     #***  #  **   ****  **   #  #                                                                                 
...
public class ASCIIArt implements Runnable { // <1>
    ...
    @Parameters(paramLabel = "word1 [word2]", defaultValue = "Hello, picocli", // <4>
               description = "Words to be translated into ASCII art.")
    private String[] words = { "Hello,", "picocli" }; // <5>

    @Override
    public void run() { // <6>
        // code for generation of ASCII art graphics
...
----
$ ASCIIArt --help
Usage: ASCIIArt [-hV] [-s=<fontsize>] [word1 [word2]...]
