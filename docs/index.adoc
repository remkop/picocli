...
dependencies {
    compile 'info.picocli:picocli:4.1.3'
    annotationProcessor 'info.picocli:picocli-codegen:4.1.3'
}
```
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.1.3')`. The old artifact id `@Grab('info.picocli:picocli:4.1.3')` will not work,
