...
and generating polished, easily tailored usage help messages. With colors.
...
to let users run command line applications without requiring picocli as an external dependency:
