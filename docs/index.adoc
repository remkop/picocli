...
==== Gradle
----
compile 'info.picocli:picocli:4.0.4-SNAPSHOT'
----
...
dependencies {
    compile 'info.picocli:picocli:4.0.4-SNAPSHOT'
    annotationProcessor 'info.picocli:picocli-codegen:4.0.4-SNAPSHOT'
}
```
...
[source,groovy]
----
@Grab('info.picocli:picocli-groovy:4.0.4-SNAPSHOT')
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.0.4-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.0.4-SNAPSHOT')` will not work,
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "4.0.4-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="4.0.4-SNAPSHOT" />
----
