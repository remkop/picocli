...
The `picocli-codegen` module includes an annotation processor that instantly enables your JAR for GraalVM native images.
...
dependencies {
    compile 'info.picocli:picocli:4.0.0-rc-1-SNAPSHOT'
    annotationProcessor 'info.picocli:picocli-codegen:4.0.0-rc-1-SNAPSHOT'
}
```
