...
public class MySpringBootApp implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        new CommandLine(myCommand).execute(args);
    }
}
----
...
class MyApp implements Runnable {
    ...
    static void main(String[] args) {
        new CommandLine(new MayApp()).execute(args)
    }
}
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.0.0-beta-1b')`. The old artifact id `@Grab('info.picocli:picocli:4.0.0-beta-2-SNAPSHOT')` will not work,
...
=== Gradle
----
compile 'info.picocli:picocli:4.0.0-beta-2-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "4.0.0-beta-2-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="4.0.0-beta-2-SNAPSHOT" />
----
