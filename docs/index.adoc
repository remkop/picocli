...
[source,groovy]
----
@Grab('info.picocli:picocli:3.9.7-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:3.9.7-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "3.9.7-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="3.9.7-SNAPSHOT" />
----
