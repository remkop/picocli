...
[source,groovy]
----
@Grab('info.picocli:picocli:3.7.0-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:3.7.0-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "3.7.0-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="3.7.0-SNAPSHOT" />
----
