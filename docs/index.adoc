...
dependencies {
    // ...
    kapt 'info.picocli:picocli-codegen:4.6.3-SNAPSHOT'
}
```
...
[source,bash]
----
java -cp "picocli-4.6.3-SNAPSHOT.jar:checksum.jar" CheckSum --algorithm SHA-1 hello.txt
----
...
[source,bash]
----
java -cp "picocli-4.6.3-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp Sarah Lea
----
...
[source,bash]
----
java -cp "picocli-4.6.3-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp --locale=es Sarah Lea
----
...
[source,bash]
----
java -cp "picocli-4.6.3-SNAPSHOT.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
----
path/to/native-image -cp picocli-4.6.3-SNAPSHOT.jar --static -jar myapp.jar
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.6.3-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.6.3-SNAPSHOT')` will not work,
