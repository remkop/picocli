...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.0.0-beta-1-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.0.0-rc-1-SNAPSHOT')` will not work,
