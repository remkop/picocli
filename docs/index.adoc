...
dependencies {
    implementation 'info.picocli:picocli:4.7.3-SNAPSHOT'
    annotationProcessor 'info.picocli:picocli-codegen:4.7.3-SNAPSHOT'
}
...
dependencies {
    // ...
    kapt 'info.picocli:picocli-codegen:4.7.3-SNAPSHOT'
}
```
...
[source,bash]
----
java -cp "picocli-4.7.3-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp Sarah Lea
----
...
[source,bash]
----
java -cp "picocli-4.7.3-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp --locale=es Sarah Lea
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.7.3-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.7.3-SNAPSHOT')` will not work,
...
Picocli has only one source file: link:https://github.com/remkop/picocli/blob/v4.7.3-SNAPSHOT/src/main/java/picocli/CommandLine.java[CommandLine.java].
