...
or with a system property: set system property `picocli.useSimplifiedAtFiles` without a value or with value `"true"`
(case-insensitive) to enable this simpler argument file format. The system property is useful to allow end users control over the format.
