...
----
@Grab('info.picocli:picocli-groovy:4.6.2-SNAPSHOT')
import picocli.CommandLine
...
----
dependencies {
    implementation 'info.picocli:picocli:4.6.2-SNAPSHOT'
}
----
.Maven
...
dependencies {
    // ...
    kapt 'info.picocli:picocli-codegen:4.6.2-SNAPSHOT'
}
```
...
[source,bash]
----
java -cp "picocli-4.6.2-SNAPSHOT.jar:checksum.jar" CheckSum --algorithm SHA-1 hello.txt
----
...
----
dependencies {
    implementation 'info.picocli:picocli-spring-boot-starter:4.6.2-SNAPSHOT'
}
----
.Gradle (Kotlin)
[source,kotlin,role="secondary"]
...
[source,bash]
----
java -cp "picocli-4.6.2-SNAPSHOT.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
[source,bash]
----
alias mycommand='java -cp "/path/to/picocli-4.6.2-SNAPSHOT.jar:/path/to/myapp.jar" org.myorg.MainClass'
----
...
----
path/to/native-image -cp picocli-4.6.2-SNAPSHOT.jar --static -jar myapp.jar
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.6.2-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.6.2-SNAPSHOT')` will not work,
...
----
libraryDependencies += "info.picocli" % "picocli" % "4.6.2-SNAPSHOT"
----

.Ivy
[source,role="secondary"]
----
<dependency org="info.picocli" name="picocli" rev="4.6.2-SNAPSHOT" />
----
...
----
@Grapes(
    @Grab(group='info.picocli', module='picocli', version='4.6.2-SNAPSHOT')
)
----
...
[source,role="secondary"]
----
[info.picocli/picocli "4.6.2-SNAPSHOT"]
----

.Buildr
[source,role="secondary"]
----
'info.picocli:picocli:jar:4.6.2-SNAPSHOT'
----

.JBang
[source,role="secondary"]
----
//DEPS info.picocli:picocli:4.6.2-SNAPSHOT
----
