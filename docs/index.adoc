...
[source,bash]
----
java -cp "picocli-4.5.1.jar:checksum.jar" CheckSum --algorithm SHA-1 hello.txt
----
...
[source,bash]
----
java -cp "picocli-4.5.1.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
[source,bash]
----
alias mycommand='java -cp "/path/to/picocli-4.5.1.jar:/path/to/myapp.jar" org.myorg.MainClass'
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.5.1')`. The old artifact id `@Grab('info.picocli:picocli:4.5.1')` will not work,
