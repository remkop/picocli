...
As of version 4.0, picocli comes with Spring Boot 2 and 3 support by providing a custom factory in the `picocli-spring-boot-starter` module.
As of version 4.7.8-SNAPSHOT, picocli comes with Spring Boot 4 support by providing a custom factory in the `picocli-spring-boot-4-starter` module.
...
This will bring in the `info.picocli:picocli` and the `info.picocli:picocli-spring-boot-starter` / `info.picocli:picocli-spring-boot-4-starter` dependencies.
