...
usage.headerHeading = This is my app. It does stuff.%n
...
The usage help of the above top-level `git` example command is very minimal:
...
With this resource bundle, the usage help for the `git` command looks like this:
