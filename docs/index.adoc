...
@Command(name = "checksum", mixinStandardHelpOptions = true, version = "checksum 4.0", // <4>
...
class CheckSum implements Callable<Integer> { // <1>
    ...
    public static void main(String... args) {
        int exitCode = new CommandLine(new CheckSum()).execute(args); // <2>
        System.exit(exitCode); // <3>
    }
