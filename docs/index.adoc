...
and let users run your application without requiring picocli as an external dependency.
...
An alternative is to use http://fusesource.github.io/jansi/[Jansi] in your application. For example:
...
ColorScheme colorScheme = new ColorScheme()
        ...
        .optionParams(Style.fg_yellow, Style.italic); // combine color and style
...
following a convention introduced by http://fusesource.github.io/jansi/[Jansi], where
...
CAUTION: Styles cannot be nested, for example: `@|bold this @|underline will not work|@|@`. This will not work. You can achieve the same by combining styles, for example: `@|bold this|@ @|bold,underline will work fine|@`.
