...
The `CommandLine.call` method is a convenience method that only invokes the `Callable` when the
command line parameters are valid. Otherwise it shows the usage help message.
