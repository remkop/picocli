...
[source,bash]
----
java -cp "picocli-4.6.2.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.6.2')`. The old artifact id `@Grab('info.picocli:picocli:4.6.2')` will not work,
