...
[source,groovy]
----
@Grab('info.picocli:picocli:4.0.0-alpha-1-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:4.0.0-alpha-1-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "4.0.0-alpha-1-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="4.0.0-alpha-1-SNAPSHOT" />
----
