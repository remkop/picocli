...
[source,groovy]
----
@Grab('info.picocli:picocli:3.0.0-alpha-3-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:3.0.0-alpha-3-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "3.0.0-alpha-3-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="3.0.0-alpha-3-SNAPSHOT" />
----
