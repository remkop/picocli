...
[source,bash]
----
java -cp "picocli-4.7.7-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp Sarah Lea
----
...
[source,bash]
----
java -cp "picocli-4.7.7-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp --locale=es Sarah Lea
----
...
----
dependencies {
    implementation 'info.picocli:picocli-spring-boot-starter:4.7.7-SNAPSHOT'
}
----
.Gradle (Kotlin)
[source,kotlin,role="secondary"]
...
[source,bash]
----
java -cp "picocli-4.7.7-SNAPSHOT.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
[source,bash]
----
alias mycommand='java -cp "/path/to/picocli-4.7.7-SNAPSHOT.jar:/path/to/myapp.jar" org.myorg.MainClass'
----
...
----
path/to/native-image -cp picocli-4.7.7-SNAPSHOT.jar --static -jar myapp.jar
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.7.7-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.7.7-SNAPSHOT')` will not work,
...
----
libraryDependencies += "info.picocli" % "picocli" % "4.7.7-SNAPSHOT"
----

.Ivy
[source,role="secondary"]
----
<dependency org="info.picocli" name="picocli" rev="4.7.7-SNAPSHOT" />
----
...
----
@Grapes(
    @Grab(group='info.picocli', module='picocli', version='4.7.7-SNAPSHOT')
)
----
...
[source,role="secondary"]
----
[info.picocli/picocli "4.7.7-SNAPSHOT"]
----

.Buildr
[source,role="secondary"]
----
'info.picocli:picocli:jar:4.7.7-SNAPSHOT'
----

.JBang
[source,role="secondary"]
----
//DEPS info.picocli:picocli:4.7.7-SNAPSHOT
----

=== Source

By using picocli in source form, you can avoid having an external dependency on picocli.
Picocli has only one source file: link:https://github.com/remkop/picocli/blob/v4.7.7-SNAPSHOT/src/main/java/picocli/CommandLine.java[CommandLine.java].
