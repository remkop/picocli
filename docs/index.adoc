...
----
class Args {
    @field:Option(names = arrayOf("-h", "--help"), usageHelp = true,
...
class MyApp extends Runnable {
  ...
  @Option(names = Array("-c", "--count"), description = Array("the count"), paramLabel = "COUNT")
  private val count: Int = 0

  @Option(names = Array("-h", "--help"), description = Array("print this help and exit"), usageHelp = true)
  private val helpRequested: Boolean = false

  @Option(names = Array("-V", "--version"), description = Array("print version info and exit"), versionHelp = true)
