...
[source,groovy]
----
@Grab('info.picocli:picocli:2.0.4-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:2.0.4-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "2.0.4-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="2.0.4-SNAPSHOT" />
----
