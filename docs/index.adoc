...
From picocli 2.4, fields annotated with `@Unmatched` will be populated with the unmatched arguments.
...
unmatched arguments list returned by `CommandLine.getUnmatchedArguments()` and fields annotated with `@Unmatched`.
...
[source,groovy]
----
@Grab('info.picocli:picocli:2.3.1-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:2.3.1-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "2.3.1-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="2.3.1-SNAPSHOT" />
----
