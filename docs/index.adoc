...
[source,kotlin]
----
@Command(name = "MyApp", version = ["Kotlin picocli demo v3.0"],
        mixinStandardHelpOptions = true, // add --help and --version options
...
[source,scala]
----
@Command(name = "MyApp", version = Array("Scala picocli demo v3.0"),
  mixinStandardHelpOptions = true, // add --help and --version options
...
=== Gradle
----
compile 'info.picocli:picocli:3.0.0-beta-3-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "3.0.0-beta-3-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="3.0.0-beta-3-SNAPSHOT" />
----
