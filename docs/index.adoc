...
and generating polished and easily tailored usage help messages.
...
== API Javadoc
Picocli API Javadoc can be found https://remkop.github.io/picocli/docs/apidocs[here].
...
== Download
Binaries are available from the GitHub project https://github.com/remkop/picocli/releases[Releases].
