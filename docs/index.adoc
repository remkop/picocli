...
[source,groovy]
----
@Grab('info.picocli:picocli:3.0.0-beta-1-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:3.0.0-beta-1-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "3.0.0-beta-1-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="3.0.0-beta-1-SNAPSHOT" />
----
