...
As of version 4.0, picocli comes with Spring Boot support by providing a custom factory in the `picocli-spring-boot-starter` and `picocli-spring-boot-4-starter` modules.
