...
(https://github.com/remkop/picocli/issues/161[This ticket] explains why not; feel free to add your comments.)
...
if (parsedCommands.get(0).isUsageHelpRequested()) {
   parsedCommands.get(0).usage(System.err);
   return;
}
----
