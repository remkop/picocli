...
If such an option is specified without a value on the command line, it is assigned an empty String.
...
[source,groovy]
----
@Grab('info.picocli:picocli:2.2.3-SNAPSHOT')
...
=== Gradle
----
compile 'info.picocli:picocli:2.2.3-SNAPSHOT'
----
...
=== Scala SBT
----
libraryDependencies += "info.picocli" % "picocli" % "2.2.3-SNAPSHOT"
----

=== Ivy

----
<dependency org="info.picocli" name="picocli" rev="2.2.3-SNAPSHOT" />
----
