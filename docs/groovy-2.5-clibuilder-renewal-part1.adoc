...
link:groovy-2.5-clibuilder-renewal-part2.html[Part 2] of this article will talk about how you can leverage some of the advanced features of the underlying libraries from CliBuilder. This is where you can make your command line application really shine. Stay tuned...