...
image::CliBuilder2.5-cygwin.png[]
...
image::a-annotations.png[Annotations]
...
=== Script Annotations
image::GroovyScriptAnnotations.png[Script]
...
image::FeatureIconAdvancedOptions.png[]
