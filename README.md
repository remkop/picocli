...
### Scala SBT
```
libraryDependencies += "info.picocli" % "picocli" % "3.5.1"
```
### Ivy
```
<dependency org="info.picocli" name="picocli" rev="3.5.1" />
```
### Grape
```groovy
@Grapes(
    @Grab(group='info.picocli', module='picocli', version='3.5.1')
)
```
### Leiningen
```
[info.picocli/picocli "3.5.1"]
```
### Buildr
```
'info.picocli:picocli:jar:3.5.1'
```
