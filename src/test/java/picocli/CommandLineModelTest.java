...
public class CommandLineModelTest {
    ...
    public void testArgSpecBuilderSetTypeInfo() {
        ...
        OptionSpec.Builder builder = OptionSpec.builder("-x").typeInfo(typeInfo);
    ...
    public void testRuntimeTypeInfoConstructor() {
        RuntimeTypeInfo runtimeTypeInfo = new RuntimeTypeInfo(List.class, new Class[]{String.class}, null);
    ...
    public void testRuntimeTypeInfoIsArray() {
        ...
        assertTrue(new RuntimeTypeInfo(String[].class, new Class[]{String[].class}, null).isArray());
    }
    ...
    public void testRuntimeTypeInfoEquals() {
        ...
        assertTrue(runtimeTypeInfo.equals(new RuntimeTypeInfo(List.class, new Class[]{String.class}, null)));

        assertFalse(runtimeTypeInfo.equals(new RuntimeTypeInfo(String.class, new Class[]{String.class}, null)));
        assertFalse(runtimeTypeInfo.equals(new RuntimeTypeInfo(List.class, new Class[]{Integer.class}, null)));
    }
    ...
    public void testTypedMemberGetAuxiliaryTypes() throws Exception {
        class App {
            @Option(names = "-x") public char x;
        }
        Field f = App.class.getDeclaredField("x");
        TypedMember typedMember = new TypedMember(f);
    ...
    public void testTypedMemberGetMethodParamPosition() throws Exception {
        class App {
            @Command
            public void mymethod(@Option(names = "-x") char x) {}
        }
        Method method = App.class.getDeclaredMethod("mymethod", char.class);
        MethodParam param = new MethodParam(method, 0);

        TypedMember typedMember = new TypedMember(param, new App());
